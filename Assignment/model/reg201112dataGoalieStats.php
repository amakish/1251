<?php
	...
	for($i=1; $sPlyrNumXXOf != $sPlyrNumOfYYY; $i++) {
		$sStatsRookie = getGoalieStats("http://www.nhl.com/ice/playerstats.htm?fetchKey=20122ALLSASAll&gameType=2&team=&position=G&country=&status=R&viewName=summary&pg=$i", "fgetRowsStatsRookie");						   

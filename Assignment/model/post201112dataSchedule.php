<?php
	...
	$fgetRowsSched = function($aRows){
		foreach ($aRows[0] as $aRow){
			if ((strpos($aRow,'<th') === false) &&
				...
				// create new schedule
				$oSchedule = new post201112tschedule;
	...
	// ******************************************************
	// Logic
	$sSched = getSched("http://www.nhl.com/ice/schedulebyseason.htm?season=20112012&gameType=3&team=&network=&venue=", $fgetRowsSched);
?>
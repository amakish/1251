<?php
	...
	$fgetRowsSched = function($aRows){
		foreach ($aRows[0] as $aRow){
			if ((strpos($aRow,'<th') === false) &&
				...
				// create new schedule
				$oSchedule = new post201011tschedule;
	...
	// ******************************************************
	// Logic
	$sSched = getSched("http://www.nhl.com/ice/schedulebyseason.htm?season=20102011&gameType=3&team=&network=&venue=", $fgetRowsSched);
?>